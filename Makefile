...
deploy-dao-local:
	forge script script/DeployDao.s.sol:DeployDao -f http://0.0.0.0:8545 --chain-id 31337 --broadcast

deploy-note-local:
	forge script script/DeployNote.s.sol:DeployNote -f http://0.0.0.0:8545 --chain-id 31337 --broadcast
